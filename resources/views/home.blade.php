...
@section('content')
<h3>Bem vind{{ Auth::user()->gender == 'female' ? 'a' : 'o' }},
    <b>{{ strtoupper(current(explode(" ", Auth::user()->name))) }}</b></h3>
        ...
        <div class="card card-primary card-outline">
            <div class="card-body box-profile">
                ...
                <ul class="list-group list-group-unbordered mb-3">
                    ...
                    <li class="list-group-item">
                        <b>Gênero</b> <a class="float-right">{{ Auth::user()->gender }}</a>
                    </li>
                    <li class="list-group-item">
    ...
    <div class="col-6">
        <div class="card card-primary">
            ...
            <div class="card-body">
                ...
                <p class="text-muted">São Paulo - SP. Brasil.</p>
                ...
                <p class="text-muted">Sou uma pessoa muito extrovertida e com focos nos objetivos.</p>
            </div>
        </div>
    </div>
</div>
