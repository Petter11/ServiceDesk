                ...
                <div class="form-row">
                    ...
                    <div class="form-group">
                        ...
                        <select name="classe" class="form-control">
                            <option value="VISUAL"
                                {{ isset($user) && $user->classe == "VISUAL" ? "selected='selected'" : ""}}>VISUAL
                            </option>
                            <option value="SONORO"
                                {{ isset($user) && $user->classe == "SONORO" ? "selected='selected'" : ""}}>SONORO
                            </option>
                            <option value="FISICO"
                                {{ isset($user) && $user->classe == "FISICO" ? "selected='selected'" : ""}}>FISICO
                            </option>
                            <option value="GLITCHS"
                                {{ isset($user) && $user->classe == "GLITCHS" ? "selected='selected'" : ""}}>GLITCHS
                            </option>
                            <option value="FINANCEIRO"
                                {{ isset($user) && $user->classe == "FINANCEIRO" ? "selected='selected'" : ""}}>
                                FINANCEIRO</option>
                        </select>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <select name="profile" class="form-control">
                            ...
                            <option value="U" {{ isset($user) && $user->status == "U" ? "selected='selected'" : ""}}>
                                User</option>
                        </select>
                    </div>
